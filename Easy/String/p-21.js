/**
 * Problem Statement: Pad a string on the left side until it reaches a desired length?
 * Problem Statement: Pad a string on the left (like padStart)?
 *
 *
 * This works similar to JavaScript's built-in `String.prototype.padStart()`.
 *
...
/* ======================================================
   Solution 01: Using built-in padStart (Modern JS)
   ====================================================== */

/**
 * This solution uses JavaScript's built-in `padStart()` method.
 * Best choice in real-world production code.
**/

const padLeftModern = (str, targetLength, padChar = " ") => {

   if (typeof str !== "string") return str;

   const addedpadStart = str.padStart(targetLength, padChar);

   return addedpadStart
};

console.log(padLeftModern("Badal", 10, "*")); // "*****Badal"

/* ======================================================
   Solution 02: Using loop(custom)
   ====================================================== */

const padLeftLoop = (str, targetLength, padChar = " ") => {
...
// Test cases
console.log(padLeftLoop("Hi", 6, ".")); // "....Hi"


/**
 * ======================================================
 * Solution 03: Interview-style loop solution (padLeft)
 * ======================================================
 *
 * Problem Statement:
 * ------------------
 * Pad a string on the Left side until it reaches a given length.
 * If the string is already equal to or longer than the target length,
 * return the original string.
 *
 * This solution avoids using built-in methods like `padStart()`
 ...
 *     //    Add `padChar` to the Left side of `result`.
